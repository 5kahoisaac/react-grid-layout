...
function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /*:: import type {
...
class ReactGridLayout extends React.Component /*:: <Props, State>*/{
  constructor() {
    ...
    _defineProperty(this, "state", {
      ...
      (0, _utils.compactType)(this.props), this.props.allowOverlap, this.props.maxProps),
      mounted: false,
      oldDragItem: null,
      oldLayout: null,
      oldResizeItem: null,
    ...
    _defineProperty(this, "onDrag", (i, x, y, _ref2) => {
      ...
      const oldLayoutClone = (0, _utils.cloneLayout)(layout);
      ...
      let compactedLayout = (0, _utils.compact)(layout, (0, _utils.compactType)(this.props), cols, undefined, maxRows);
    ...
    _defineProperty(this, "onDragStop", (i, x, y, _ref3) => {
      ...
      const oldLayoutClone = (0, _utils.cloneLayout)(oldLayout);
    ...
    _defineProperty(this, "onResize", (i, w, h, _ref5) => {
      ...
      let compactedLayout = (0, _utils.compact)(finalLayout, (0, _utils.compactType)(this.props), cols, undefined, maxRows);
    ...
    _defineProperty(this, "removeDroppingPlaceholder", () => {
      ...
      const oldLayoutClone = (0, _utils.cloneLayout)(layout);
      const newLayout = (0, _utils.compact)(layout.filter(l => l.i !== droppingItem.i), (0, _utils.compactType)(this.props), cols, allowOverlap, maxRows);
      this.setState({
  ...
  static getDerivedStateFromProps(nextProps /*: Props*/, prevState /*: State*/) /*: $Shape<State> | null*/{
    ...
    const oldLayoutClone = (0, _utils.cloneLayout)(prevState.layout);
