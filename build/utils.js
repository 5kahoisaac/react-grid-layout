 ...
 */
function compact(layout /*: Layout*/, compactType /*: CompactType*/, cols /*: number*/, allowOverlap /*: ?boolean*/, maxRows /*: ?number*/) /*: Layout*/{
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    if (!l.static) {
      l = compactItem(compareWith, l, compactType, cols, sorted, allowOverlap, maxRows);
 ...
 *
 */
function compactItem(compareWith /*: Layout*/, l /*: LayoutItem*/, compactType /*: CompactType*/, cols /*: number*/, fullLayout /*: Layout*/, allowOverlap /*: ?boolean*/, maxRows /*: ?number*/) /*: LayoutItem*/{
 ...
 */
function synchronizeLayoutWithChildren(initialLayout /*: Layout*/, children /*: ReactChildren*/, cols /*: number*/, compactType /*: CompactType*/, allowOverlap /*: ?boolean*/, maxRows /*: ?number*/) /*: Layout*/{
  ...
  const compactedLayout = compact(correctedLayout, compactType, cols, allowOverlap, maxRows);
